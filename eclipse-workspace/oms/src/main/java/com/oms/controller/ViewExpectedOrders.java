...
public class ViewExpectedOrders extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ExpectedOrders> viewProducts = allOrderList.getAllExpectedOrder(query, page, nOfRecord, orderby, sortby);
        ...
        request.setAttribute("expectedOrder", viewProducts);
        request.setAttribute("totalpage", totalPage);
        request.setAttribute("currentPage", offset);
		dispatcher = request.getRequestDispatcher("pages/producer/expectedOrders.jsp");
